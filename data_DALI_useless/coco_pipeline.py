...
class COCOPipeline(Pipeline):
    ...
    def define_graph(self):
        ...
        # TODO need to know why label is 8732?  Rather than image label
...
class DALICOCOIterator(object):
    ...
    def __next__(self):
        ...
        for i in range(self._num_gpus):
            ...
            images_torch_type = to_torch_type[images[0].dtype.value]
            bboxes_torch_type = to_torch_type[bboxes[0][0].dtype.value]
            labels_torch_type = to_torch_type[labels[0][0].dtype.value]
